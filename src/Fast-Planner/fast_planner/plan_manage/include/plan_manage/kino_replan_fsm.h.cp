...
private:
  /* ---------- flag ---------- */
  enum FSM_EXEC_STATE { INIT, WAIT_TARGET, GEN_NEW_TRAJ, REPLAN_TRAJ, EXEC_TRAJ, CHECK_MAVROS_MODE,REPLAN_NEW };
  ...
  ros::Subscriber mavros_mode_sub;
  ros::Publisher mavros_mode_pub;
  void MavmodeCallback(const mavros_msgs::StateConstPtr& msg);
  ...
  /* ROS functions */
  void  checkOffboard(const ros::TimerEvent& e);
